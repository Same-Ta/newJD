                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <div className="space-y-1.5">
                                                ...
                                                <input 
                                                        ...
                                                        required 
                                                        className="w-full h-12 px-4 bg-slate-50 border border-gray-200 rounded-xl text-[15px] placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all" 
                                                />
                                        </div>
                                        ...
                                        <button 
                                                type="submit" 
                                                disabled={loading} 
                                                className="w-full bg-blue-600 text-white h-12 rounded-xl font-bold text-[15px] hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/30 mt-4 active:scale-[0.98] disabled:opacity-50"
                                        >
