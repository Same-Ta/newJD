...
export const TUTORIAL_STEPS: TutorialStepDef[] = [
  ...
  },
  {
    ...
    target: 'chat-input',
    title: '① 키워드를 입력하세요',
    description: '먼저 공고 유형을 선택한 후, 입력란에 키워드를 입력하고 전송하세요.\n예: "프론트엔드 개발자", "마케팅 인턴"\n키워드 입력 없이 바로 다음으로 넘어가려면 아래 다음 버튼을 클릭하세요.',
    position: 'top',
    waitForClick: false,
    interaction: 'input',
    group: 'AI 공고 생성',
  },
  {
    ...
    page: 'chat',
    target: 'chat-preview',
    title: 'AI가 공고를 작성 중입니다',
    description: '우측 미리보기에 공고 내용이 자동으로 생성되고 있습니다.\n제목, 역할, 요건 등 모든 내용을 AI가 자동으로 채웁니다.\n완료되면 자동으로 다음 단계로 진행됩니다.',
    position: 'left',
    waitForClick: false,
    interaction: 'wait',
    group: 'AI 공고 생성',
  },
  {
    ...
    title: '공고를 게시하세요',
    description: '생성된 공고가 마음에 드시면 게시 버튼을 클릭하세요.',
    position: 'top',
    waitForClick: true,
    interaction: 'click',
    group: 'AI 공고 생성',
