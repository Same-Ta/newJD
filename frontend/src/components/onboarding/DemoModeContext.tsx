...
export const PHASE_DESCRIPTIONS: Record<TutorialPhase, string> = {
  ...
  2: '공고 확인 → 수정 모드 → 드래그&드롭 섹션 조정 → 저장 → 공유 링크 복사',
...
export const TUTORIAL_STEPS: TutorialStepDef[] = [
  ...
  },
  {
    ...
    phase: 2,
    page: 'jd-detail',
    target: 'section-drag-first',
    title: '드래그로 섹션 순서 변경',
    description: '각 섹션 왼쪽의 드래그 핸들(⠇)을 잡고 위아래로 끌어다 놓으면 섹션 순서를 자유롭게 바꿀 수 있어요.',
    position: 'left',
    waitForClick: false,
    interaction: 'wait',
    autoAdvanceMs: 4000,
  ...
  },
  {
    ...
    phase: 2,
    page: 'jd-detail',
    target: 'section-drag-area',
    title: '섹션이 이동됩니다!',
    description: '이렇게 드래그하면 섹션의 순서가 바뀝니다.\n원하는 순서로 공고 레이아웃을 자유롭게 구성해보세요!',
    position: 'left',
    waitForClick: false,
    interaction: 'wait',
    autoAdvanceMs: 3500,
  ...
  },
  {
    ...
    phase: 2,
    page: 'jd-detail',
    target: 'section-palette',
    title: '새로운 섹션 추가하기',
    description: '팔레트에서 원하는 섹션을 드래그하여 공고에 추가할 수 있어요.\n필요한 정보를 자유롭게 구성하세요!',
    position: 'bottom',
    waitForClick: false,
    interaction: 'wait',
    autoAdvanceMs: 4000,
